    ...
    <footer class="page-footer">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-3 text-center text-md-left mb-3 mb-md-0 fut">
            ...
            <p class="border-top mb-0 mt-4 pt-3 small">&copy; <script>document.write(new Date().getFullYear())</script>, Lincoln Blog Created By <a href="javascript:void(0)" class="text-muted font-weight-bold" >iSAY Technology.</a>  All rights reserved </p> 
        </div>      
    </footer>
    <!-- End of Page Footer -->
